...
*      :: Cliente:     
*      :: Objetivo:    Enviar PDFs Nota de Credito com assinatura eletronica de seguida    
* Histórico de Versões
*      :: 19/07/2021 »» JM ::Criacao
*================================================================================================================================================
...
browlist("Escolha as notas de crédito a enviar ","factFe","factFe",.t.,.f.,.f.,.t.,.f.)
**
if .not. m.escolheu
...
********************************************************************************************
********************************************************************************************
*****2. Send Credit_Note request without QRCode 
...
***********************************************************************************************
***ENVIAR PDF
****2. Resend PDF Credit_Note notifications 
